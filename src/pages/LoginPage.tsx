...
export default function LoginPage() {
  ...
  const googleOAuthURL = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${googleClientID}&response_type=token&redirect_uri=http://localhost:3000/redirect/google&scope=https://www.googleapis.com/auth/userinfo.profile`;
  const kakaoOAuthURL = `https://kauth.kakao.com/oauth/authorize?client_id=${kakaoRestAPIKey}&redirect_uri=http://localhost:3000/redirect/kakao&response_type=code`;
